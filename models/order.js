...
module.exports = (sequelize, DataTypes) => {
    const Order = sequelize.define('Order', {
        ...
        status: {
            type: DataTypes.ENUM('PENDING', 'MATCHED', 'MATCHED_PAID', 'MATCHED_DEBT', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED'),
    ...
    Order.associate = (models) => {
        ...
        Order.belongsTo(models.ServiceRequest, { as: 'service_request', foreignKey: 'service_request_id' });
